...
public class FilesExtractionDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        PrintWriter printWriter01 = new PrintWriter(filePath + "FileF.txt");

        BufferedReader bufferedReader01 = new BufferedReader(new FileReader(filePath + "FileD.txt"));
...
//        BufferedReader bufferedReader02 = new BufferedReader(new FileReader(filePath + "FileE.txt"));
        ...
        while (line != null) {
            ...
            bufferedReader02 = new BufferedReader(new FileReader(filePath + "FileE.txt"));
